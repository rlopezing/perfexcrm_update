...
function load_small_table_item(e, t, a, i, n) {
  ...
  if (void 0 !== e && "" !== e) $("body").hasClass("small-table") || toggle_small_view(n, t);
...
function init_return(e) {
  load_small_table_item(e, "#return", "invoiceid", "returns/get_invoice_data_ajax", ".table-returns")
}
...
$("body").on("loaded.bs.select change", "select.ajax-search", function(e) {
    ...
    if (table_invoices = $("table.table-invoices"), table_estimates = $("table.table-estimates"), table_returns = $("table.table-returns"),
    	table_invoices.length > 0 || table_estimates.length > 0 || table_returns.length > 0) {
        var _ = {},
        ...
        $.each(m, function() {
            ...
            [3, "desc"],
            [0, "desc"]
        ]), table_returns.length && initDataTable(table_returns, admin_url + "returns/table", "undefined", "undefined", _, [
            [3, "desc"],
            [0, "desc"]
        ])
    }
