...
function add_item_to_table(e, t, a, i) {
  ...
  {
    var n = "";
    var s = $("body").find("tbody .item").length + 1;
    
    n += '<tr class="sortable item" data-merge-invoice="' + a + '" data-bill-expense="' + i + '">'; 
    n += '<td class="dragger">'; 
    isNaN(e.qty) && (e.qty = 1), ("" === e.rate || isNaN(e.rate)) && (e.rate = 0);
    var o = e.rate * e.qty;
    ...
    return get_taxes_dropdown_template(l, e.taxname).done(function(a) {
      ...
      n += "</tr>", $("table.items tbody").append(n), $(document).trigger({
  ...
  var e, t, a, i, n, s, o = {},
    ...
    $(".tax-area").remove(), $.each(p, function() 
    {
      ...
      (a = $(this).find("select.tax").selectpicker("val")) && $.each(a, function(a, l) {
        ...
        e = n / 100 * t, o.hasOwnProperty(l) ? o[l] = o[l] += e : 0 != t && (s = l.split("|"), tax_row = '<tr class="tax-area"><td>' + s[0] + "(" + t + '%)</td><td id="tax_id_' + slugify(l) + '"></td></tr>', $(_).after(tax_row), o[l] = e);
    	})
    });
    
    ("" !== u && 0 != u && "before_tax" == v && h.hasClass("discount-type-percent")) 
    	? c = l * u / 100 
    	: "" !== f && 0 != f && "before_tax" == v && h.hasClass("discount-type-fixed") && (c = f);
    
    $.each(o, function(e, t) {
      ("" !== u && 0 != u && "before_tax" == v && h.hasClass("discount-type-percent")) 
      	? (total_tax_calculated = t * u / 100, t -= total_tax_calculated) 
      	: "" !== f && 0 != f && "before_tax" == v && h.hasClass("discount-type-fixed") && (t -= t * (f / l * 100) / 100); 
      d += t;
      t = format_money(t);
    ...
    ("" !== u && 0 != u && "after_tax" == v && h.hasClass("discount-type-percent")) 
    	? c = d * u / 100 
    	: "" !== f && 0 != f && "after_tax" == v && h.hasClass("discount-type-fixed") && (c = f);
...
function validate_return_form(e) {
    e = void 0 === e ? "#invoice-form" : e, appValidateForm($(e), {
        clientid: {
            required: {
                depends: function() {
        ...
        remote: {
            url: admin_url + "returns/validate_invoice_number",
            type: "post",
            data: {
                number: function() {
                    return $('input[name="number"]').val()
        ...
        messages: {
            remote: app.lang.return_number_exists
        }
    })
}
...
$("body").on("loaded.bs.select change", "select.ajax-search", function(e) {
    ...
    b.length > 0 && (b = b.sortable({
        ...
        requestGetJSON("returns/client_change_data/" + e + "/" + (n = void 0 === n ? "" : n)).done(function(e) {
