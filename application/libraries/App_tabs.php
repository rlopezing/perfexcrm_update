...
class App_tabs
{
    ...
    public function add_customer_profile_link($slug, $tab)
    {
        $this->add_link($slug, $tab, 'customer_profile');

        return $this;
    }
    public function add_link($slug, $tab, $group)
    {
    ...
    public function add_operation_tab_children_item($parent_slug, $tab)
    {
        $this->add_child($parent_slug, $tab, 'operation');

        return $this;
    }
    public function add_operation_tab($slug, $tab)
    {
        $this->add($slug, $tab, 'operation');

        return $this;
    }
    public function get_operation_tabs()
    {
