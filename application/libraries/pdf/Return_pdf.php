...
class Return_pdf extends App_pdf
{
    protected $invoice;
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_returnpdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/returnpdf.php';
