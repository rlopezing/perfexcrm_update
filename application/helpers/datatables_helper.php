 ...
 * @return string
 */
function render_datatable_comision($headings = [], $class = '', $valor_contrato, $comision_socio, $comision_comercial, $symbol,$columns, $additional_classes = [''], $table_attributes = [])
{
  $_additional_classes = '';
  $_table_attributes   = ' ';
  if (count($additional_classes) > 0) {
  ...
  $table = '<div class="' . $IEfix . '">';
  $table .= '<table' . $_table_attributes . 'class="dt-table-loading table table-' . $class . '' . $_additional_classes . '">';
  $table .= '<thead>';
  $table .= '<tr>';
  foreach ($headings as $heading) {
    if (!is_array($heading)) {
  ...
  $total_comision = $comision_socio + $comision_comercial;
  $total = $valor_contrato - $comision_socio - $comision_comercial;
  
  $table .= '<tfoot>';
    $table .= '<td> </td>';
    $table .= '<td class="text-right"><p class=""><strong>CONTRATOS: </strong></p></td>';
    $table .= '<td><p><strong>'.$valor_contrato.' '.$symbol.'</strong></p></td>';
    $table .= '<td> </td>';
    $table .= '<td class="text-right"><p class=""><strong>COMISIÓN: </strong></p></td>';
    $table .= '<td><p><strong>'.$total_comision.' '.$symbol.'</strong></p></td>';
    $table .= '<td class="text-right"><p class=""><strong>TOTAL: </strong></p></td>';
    $table .= '<td><p><strong>'.$total.' '.$symbol.'</strong></p></td>';
    $table .= '<td> </td>';
    $table .= '<td> </td>';
    $table .= '<td> </td>';
    $table .= '<td> </td>';
    if ($columns==13 || $columns==23) $table .= '<td> </td>';
    if ($columns==23) {
      $table .= '<td> </td>';
      $table .= '<td> </td>';
      $table .= '<td> </td>';
 ...
 * @return string
 */
function render_datatable_presence($headings = [], $class = '', $valor_contrato, $comision_socio, $comision_comercial, $symbol,$columns, $additional_classes = [''], $table_attributes = [])
{
  $_additional_classes = '';
  $_table_attributes   = ' ';
  if (count($additional_classes) > 0) {
