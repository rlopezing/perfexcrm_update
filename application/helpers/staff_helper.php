...
function get_available_staff_permissions($data = [])
{
    ...
    $allPermissionsArrayTimeControl = [
        'view_own' => _l('permission_view_own'),
        'view'     => $viewGlobalName,
        'create'   => _l('permission_create'),
        'edit'     => _l('permission_edit'),
        'delete'   => _l('permission_delete'),
        'filter' 	 => _l('timecontrol_filter_tc'),
        'mysdays'  => _l('timecontrol_my_days'),
    ];
    
    $viewPermissionsArray = [
        'view_own' => _l('permission_view_own'),
        'view'     => $viewGlobalName,
    ];
    ...
    $corePermissions = [
        'dashboards' => [
            ...
            'capabilities' => $viewPermissionsArray,
        ],
        'bulk_pdf_exporter' => [
        ...
        'commercials_visits' => [
            'name'         => _l('commercials_visits'),
            'capabilities' => $allPermissionsArray,
        ],
        'documents_control' => [
            'name'         => _l('documents_control'),
            'capabilities' => $allPermissionsArray,
        ],
        'operations' => [
            'name'         => _l('operations'),
        ...
        'time_controls' => [
            ...
            'capabilities' => $allPermissionsArrayTimeControl,
        ],
    ];
