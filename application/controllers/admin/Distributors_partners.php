...
class Distributors_partners extends Admin_controller
{
  public function __construct()
  {
    parent::__construct();
    $this->load->model('distributor_partner_model');
  ...
  public function index()
  {
    if ($this->input->is_ajax_request()) {
        $this->app->get_table_data('distributor_partner');
    }
    
    $data['email_exist_as_staff'] = $this->email_exist_as_staff();
    $data['title']                = _l('distributor_partner_title');
    ...
    $data['valor_contrato'] = $this->distributor_partner_model->get_valor_contrato($_SESSION['$fdesde'],$_SESSION['$fhasta']);
    $data['comision_socio'] = $this->distributor_partner_model->get_comision_socio($_SESSION['$fdesde'],$_SESSION['$fhasta']);
    $data['comision_comercial'] = $this->distributor_partner_model->get_comision_comercial($_SESSION['$fdesde'],$_SESSION['$fhasta']);
    
    $data['base_currency'] = $this->currencies_model->get_base_currency();
        
    $this->load->view('admin/distributor_partner/manage', $data);
  }
  ...
  public function filtrar()
  {
    ...
    log_message('debug', "data['total']: ".print_r($data['total'], TRUE));
		
    $this->load->view('admin/distributor_partner/manage', $data);
  }
  
  /* Edit or add new general map */
  public function distributor_partner($id = '')
  {
    if ($this->input->post()) {
      $message          = '';
