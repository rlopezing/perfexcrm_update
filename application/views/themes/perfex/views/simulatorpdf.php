...
$content .= '<tr><td>'._l('simulator_savings').' '._l('simulator_price_potency').' (€):</td><td>'.$simulator->savings_potency.'</td></tr>';
$content .= '<tr><td>'._l('simulator_savings').' '._l('simulator_price_potency').' (€):</td><td>'.$simulator->savings_energy.'</td></tr>';
