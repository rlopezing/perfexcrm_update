...
$info_right_column .= '<span style="font-weight:bold;font-size:27px;">' . _l('return_pdf_heading') . '</span><br />';
...
// Bill to
$invoice_info = '<b>' . _l('return_bill_to') . '</b>';
...
$invoice_info .= '<br />' . _l('return_data_date') . ' ' . _d($invoice->date) . '<br />';
...
// The items table
$items = get_items_table_data($invoice, 'return', 'pdf');
