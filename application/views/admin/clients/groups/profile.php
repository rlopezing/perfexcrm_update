    ...
    <div class="horizontal-scrollable-tabs">
         ...
         <div class="horizontal-tabs">
            <ul class="nav nav-tabs profile-tabs row customer-profile-tabs nav-tabs-horizontal" role="tablist">
              ...
              <?php if(isset($client) && has_permission('simulators', '', 'create')) { ?>
	              <li role="presentation" class="<?php if($this->input->get('tab') == "supply_points"){echo 'active';}; ?>">
	                  <a href="#supply_points" aria-controls="supply_points" role="tab" data-toggle="tab">
	                  <?php echo _l( 'supply_points'); ?>
	                  </a>
	              </li>
	          	<?php } ?>
          </ul>
         ...
         <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab')){echo ' active';}; ?>" id="contact_info">
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <?php echo render_select('type',$types,array('id','type'), 'commercials_visits_type',$selected); ?>
               ...
               <div class="col-md-6">
                  ...
                  ?>
      						<div class="form-group">
         						...
         						<?php $value=( isset($client) ? unserialize($client->default_tax) : ''); ?>
         						<?php echo $this->misc_model->get_taxes_dropdown_template('default_tax[]',$value); ?>
      						</div>
               </div>
            </div>
         </div>
         ...
         <div role="tabpanel" class="tab-pane" id="billing_and_shipping">
            <div class="row">
               <div class="col-md-12">
				...
				<!-- Puntos de suminitros -->
        <div role="tabpanel" class="tab-pane" id="supply_points">
          <?php if (has_permission('customers', '', 'create') || has_permission('customers', '', 'edit')) { ?>
          	<a href="#" data-toggle="modal" data-target="#supply_points_modal" class="btn btn-info mbot30"><?php echo _l('supply_points_new'); ?></a>
          	<a href="#" data-toggle="modal" data-target="#supply_points_gas_modal" class="btn btn-info mbot30"><?php echo _l('supply_points_gas_new'); ?></a>
          <?php } ?>
          <table class="table dt-table">
            <thead>
              <tr>
                <th><?php echo _l('supply_points_module'); ?></th>
                <th><?php echo _l('supply_points_cups'); ?></th>
                <th><?php echo _l('supply_points_country'); ?></th>
                <?php if(has_permission('customers','','create') || has_permission('customers','','edit')){ ?>
                  <th><?php echo _l('options'); ?></th>
                <?php } ?>
              </tr>
            ...
            <tbody>
              <?php foreach($supply_points as $c_admin){ ?>
              <tr>
                <td data-order="<?php echo $c_admin['module']; ?>"><?php echo $c_admin['module']; ?></td>
                <td data-order="<?php echo $c_admin['cups']; ?>"><?php echo $c_admin['cups']; ?></td>
                <td data-order="<?php echo $c_admin['country']; ?>"><?php echo $c_admin['short_name']; ?></td>
                <?php if(has_permission('customers','','create') || has_permission('customers','','edit')){ ?>
                <td>
                	<?php if ($c_admin['module_id'] == 2) { ?>
										<a href="#" class="btn btn-default btn-icon" onclick="edit_supply_points(<?php echo $c_admin['cliente']; ?>,<?php echo $c_admin['id']; ?>); return false;" aria-disabled="true">
    									<i class="fa fa-pencil-square-o"></i>
    								</a>       
                  <?php } ?>
                	<?php if ($c_admin['module_id'] == 4) { ?>
										<a href="#" class="btn btn-default btn-icon" onclick="edit_supply_points_gas(<?php echo $c_admin['cliente']; ?>,<?php echo $c_admin['id']; ?>); return false;" aria-disabled="true">
    									<i class="fa fa-pencil-square-o"></i>
    								</a>
    							<?php } ?>       
                	<a href="<?php echo admin_url('clients/delete_supply_points/'.$c_admin['id'].'/'.$c_admin['cliente']); ?>" class="btn btn-danger _delete btn-icon">
...
<?php $this->load->view('admin/clients/modals/supply_points'); ?>
<?php $this->load->view('admin/clients/modals/supply_points_gas'); ?>
