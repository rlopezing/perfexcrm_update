      ...
      <div class="col-md-12">
        <div class="panel_s">
          ...
          <div class="panel-body _buttons">
            <?php if(has_permission('simulators','','create')) { ?>
              <div class="col-md-12 pull-right" style="padding: 0px;">
                <a class="text-uppercase pull-left"><h3><?php echo _l('simulator_rate'); ?></h3></a>
              </div>
              <a href="<?php echo admin_url('simulators/simulator'); ?>" class="btn btn-info pull-left display-block"><?php echo _l('simulator_new'); ?></a>
            <?php } ?>
          ...
          <div class="panel-body">
            <?php $this->load->view('admin/simulator/table_html'); ?>
         	</div>
       	</div>
      </div>
    </div>
...
<script>
  ...
  $(function() {
    ...
    initDataTable('.table-contracts', admin_url+'simulators/table', undefined, undefined, ContractsServerParams,<?php echo do_action('contracts_table_default_order',json_encode(array(6,'asc'))); ?>);
  });
