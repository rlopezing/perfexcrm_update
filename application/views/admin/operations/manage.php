      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
            <div class="_buttons">
              <h4 class="col-md-3" style="padding-left: 0px;"><strong>Operaciones.</strong></h4>
              <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
               ...
               <div class="row mbot15">
                <div class="col-md-12">
                  <h4 class="no-margin"><?php echo _l('operation_summary'); ?></h4>
                  <?php
                  $_where = '';
                  if(!has_permission('operations','','view')){
                    $_where = 'id IN (SELECT id FROM '.db_prefix().'cvisit WHERE addedfrom='.get_staff_user_id().')';
                  }
                  ?>
                </div>
                  ...
                  foreach($statuses as $status) {
                    ...
                    <div class="col-md-2 col-xs-6 border-right">
                      ...
                      <a href="#" onclick="dt_custom_view('project_status_<?php echo $status['id']; ?>','.table-projects','project_status_<?php echo $status['id']; ?>',true); return false;">
                        <h3 class="bold"><?php echo total_rows(db_prefix().'cvisit',$where); ?></h3>
            ...
            <div class="clearfix"></div>
             ...
             <?php $this->load->view('admin/operations/table_html'); ?>
          </div>
        </div>
      </div>
    </div>
...
<?php $this->load->view('admin/operations/copy_settings'); ?>
<?php init_tail(); ?>
<script>
$(function() {
  ...
  initDataTable('.table-operations', admin_url+'Operations/table', undefined, undefined, ProjectsServerParams, <?php echo hooks()->apply_filters('projects_table_default_order', json_encode(array(5,'asc'))); ?>);
