      ...
      <div class="col-md-12">
        <div class="panel_s">
          ...
          <div class="panel-body _buttons">
            <?php if (has_permission('commercials_visits','','create')){ ?>
              <div class="col-md-12 pull-right" style="padding: 0px;">
                 <a class="text-uppercase pull-left"><h3><?php echo _l('commercials_visits'); ?></h3></a>
              </div>
            <a href="<?php echo admin_url('clients/client'); ?>" class="btn btn-info pull-left display-block" style="margin-right: 5px;"><?php echo _l('new_client'); ?></a>
              <a href="<?php echo admin_url('commercials_visits/commercial_visit'); ?>" class="btn btn-info pull-left display-block">
                <?php echo _l('commercial_visit_new'); ?>
              </a>
            <?php } ?>
          </div>
        </div>
        <div class="panel_s">
          ...
          <div class="panel-body">
            <?php $this->load->view('admin/commercial_visit/table_html'); ?>
         	</div>
       	</div>
   		</div>
    </div>
...
<script>
  ...
  $(function(){
    ...
    initDataTable('.table-commercials-visits', admin_url+'commercials_visits/table', undefined, undefined, ContractsServerParams,<?php echo do_action('contracts_table_default_order',json_encode(array(2,'asc'))); ?>);
  });
