  ...
  <div class="panel_s mbot10">
    <div class="panel-body _buttons">
      ...
      <?php if(has_permission('invoices','','create')){ ?>
      	<?php $disabled = (!isset($cliente_id) || $cliente_id == "") ? 'disabled' : '' ?>
        <a href="<?php echo admin_url('invoices/invoice'); ?>" class="btn btn-info pull-left new new-invoice-list mright5" <?php echo $disabled; ?>>
        	<?php echo _l('create_new_invoice'); ?>
        </a>
      <?php } ?>
      <?php if(!isset($project)){ ?>
        <a href="<?php echo admin_url('invoices/recurring'); ?>" class="btn btn-info pull-left" <?php echo $disabled; ?>>
          <?php echo _l('invoices_list_recurring'); ?>
        </a>
      <?php } ?>
      <?php echo form_open(admin_url('invoices/filtrar'), array('id'=>'filtrar-form')); ?>
