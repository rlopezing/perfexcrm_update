  ...
  <div class="row">
    <?php
      ...
      <div class="col-md-6 col-sm-6">
         <h4 class="bold">
            <?php
               ...
               ?>
            <a href="<?php echo admin_url('returns/invoice/'.$invoice->id); ?>">
      ...
      <div class="col-sm-6 text-right">
         <span class="bold"><?php echo _l('return_bill_to'); ?>:</span>
         <address>
  ...
  <div class="row">
    <div class="col-md-12">
         <div class="table-responsive">
            <?php
               $items = get_items_table_data($invoice, 'return', 'html', true);
               echo $items->table();
             ?>
         </div>
      </div>
