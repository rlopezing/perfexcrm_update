<?php init_head(); ?>
    	...
    	<div class="row">
          ...
          <div class="panel_s">
            <div class="panel-body">
              <div class="_buttons">
              	<div class="row">
              		<div class="col-md-3">
									...
									<?php echo form_open(admin_url('distributors_commercials/filtrar'), array('id'=>'filtrar-form')); ?>
              ...
              ),'distributor-commercial',$valor_contrato,0,$comision_comercial,$base_currency->symbol,12); ?>
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
	  $(function() {
	    initDataTable('.table-distributor-commercial', window.location.href, [3], [3]);
	 	});
      ...
      $.post(url, data).done(function(response) {
        ...
        $('.table-distributor-commercial').DataTable().ajax.reload();
      }).fail(function(data) {
