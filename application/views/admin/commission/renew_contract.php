<div class="modal fade" id="renew_contract_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <?php echo form_open(admin_url('commissions/renew'),array('id'=>'renew-contract-form')); ?>
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                $new_end_date_assume = '';
                if(!empty($contract->fecha_fin_suministro)){
                ...
                <?php echo render_input('new_value','contract_value',$contract->valor_contrato,'number'); ?>
              ...
              <?php echo form_hidden('old_start_date',$contract->fecha_inicio_suministro); ?>
              <?php echo form_hidden('old_end_date',$contract->fecha_fin_suministro); ?>
              <?php echo form_hidden('old_value',$contract->valor_contrato); ?>
          </div>
