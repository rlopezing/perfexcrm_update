<?php
	...
	foreach ($rResult as $aRow) {
	  ...
	  $subjectOutput = '<a href="'.admin_url('gass/gas/'.$aRow['tblsimulators.id']).'">'.$aRow['tblsimulators.cups'].'</a>';
	  ...
	  if (has_permission('contracts', '', 'edit')) {
	    $subjectOutput .= '<a href="'.admin_url('gass/gas/'.$aRow['tblsimulators.id']).'">'._l('edit').'</a>';
	  }
	  if (has_permission('contracts', '', 'delete')) {
	    $subjectOutput .= ' | <a href="'.admin_url('gass/delete/'.$aRow['tblsimulators.id']).'" class="text-danger _delete">'._l('delete').'</a>';
	  }
	  $subjectOutput .= '</div>';
	  $row[] = $subjectOutput;
