...
foreach ($types as $type) {
    if ($this->ci->input->post('cvisit_by_type_' . $type['id'])) {
...
*/
$years      = $this->ci->documents_control_model->get_visits_years();
$yearsArray = [];
...
$result = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, [db_prefix() . 'cvisit.id', 'trash', 'client', 'hash']);
